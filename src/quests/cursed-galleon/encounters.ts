...
export const encounters: Encounter[] = [
  // ── SEA / TRADE ──
  {
    ...
    text: "Купець з Мадагаскару. Від нього несе корицею та кардамоном. Пропонує угоду.",
    choices: [
      ...
      { text: "💰 Купити спецій (−15)", eff: { gold: -15, crew: 0, karma: 1, curse: 0, rep: { guild: 1 } }, msg: "Спеції зігріють холодні ночі. Дух команди міцнішає.", flag: "has_spices" },
      { text: "📜 Розпитати про чутки", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Шепоче про затонулий храм на сході, де золото ніхто не чіпає, бо воно кусається.", flag: "knows_temple" },
    ],
  },
  {
    id: "merchant_weapons", scene: "open_sea", phase: "early", title: "Контрабандист зброї",
    text: "Голландський шлюп під чужим прапором. Борти обвішані мушкетами.",
    choices: [
  ...
  },
  {
    ...
    text: "Бочки рому хитаються на хвилях після аварії. Десятки бочок.",
    choices: [
  ...
  },
  {
    ...
    text: "Зграя китів пливе поруч. Велетенські, спокійні, прадавні.",
    choices: [
  ...
  // ── STORMS ──
  {
    ...
    text: "Стіна дощу. Щогла тріщить. Хвилі перехльостують через борт.",
    choices: [
  ...
  },
  {
    ...
    text: "Воїни виходять з джунглів. Їхня ватажка — жінка зі шрамами та мудрими очима.",
    choices: [
