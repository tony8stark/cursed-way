...
export const encounters: Encounter[] = [
  // ── SEA / TRADE ──
  {
    ...
    choices: [
      ...
      { text: "💰 Купити спецій (−15)", eff: { gold: -15, crew: 0, karma: 1, curse: 0, rep: { guild: 1 } }, msg: "Спеції зігріють холодні ночі. Команда повеселішала.", flag: "has_spices" },
      { text: "📜 Розпитати про чутки", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Шепоче про затонулий храм на сході. Мовляв, золото там ніхто не чіпає, бо воно кусається.", flag: "knows_temple" },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: "🤝 Обмінятися відомостями", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Розповідає про британський конвой, що пройде за два дні.", flag: "knows_convoy" },
      { text: "🗝️ [Контрабандист] Старі зв'язки", eff: { gold: -10, crew: 0, karma: 0, curse: 0 }, msg: "Ви знаєте таємне рукостискання. Половина ціни, без зайвих питань. На додачу кидає бочку пороху.", flag: "armed", requires_flag: "origin_smuggler" },
      { text: "⚓ [Флот] Показати каперське свідоцтво", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Він блідне. Скидає зброю за борт і тікає. Ви виловлюєте з води добрячий пістолет.", flag: "armed", requires_flag: "origin_navy" },
      { text: "⚖️ [Торговиця] Оптова угода", eff: { gold: -15, crew: 0, karma: 1, curse: 0, rep: { guild: 1 } }, msg: "Ви називаєте оптову ціну з Макао. Він стискає руку. Зброя, порох і три бочки пороху за половину вартості. Він ще й дає адресу свого постачальника.", flag: "armed", requires_flag: "origin_merchant" },
    ],
  },
  {
  ...
  },
  {
    ...
    text: "Бочки рому хитаються на хвилях. Десятки бочок після чийогось нещастя.",
    choices: [
  ...
  },
  {
    ...
    text: "Кити пливуть поруч. Велетні, спокійні, прадавні.",
    choices: [
      { text: "🐋 Милуватись", eff: { gold: 0, crew: 1, karma: 1, curse: 0 }, msg: "На одну мить усі забувають, що вони пірати. Просто люди перед дивом." },
  ...
  // ── STORMS ──
  {
    ...
    text: "Стіна дощу налітає раптом. Щогла тріщить. Хвилі перехльостують через борт.",
    choices: [
  ...
  },
  {
    ...
    choices: [
      ...
      { text: "🙈 Відвернутися", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Чого не бачив, того нема. Принаймні, так легше спати." },
  ...
  // ── ISLANDS ──
  {
    ...
    choices: [
      ...
      { text: "🏥 Відпочити", eff: { gold: 0, crew: 1, karma: 1, curse: 0 }, msg: "День на суші. Команда знов почувається людьми." },
    ],
  },
  {
    id: "island_ruins", scene: "island", title: "Руїни храму",
    text: "Кам'яні колони, повиті зеленню. На стінах — зображення моря і чогось із глибини.",
    choices: [
  ...
  },
  {
    ...
    text: "З джунглів виходять воїни. Ведуть їх жінка зі шрамами і мудрим поглядом.",
    choices: [
      ...
      { text: "⚔️ Показати силу", eff: { gold: 0, crew: [-1, 0], karma: -2, curse: 1 }, msg: "Отруєні стріли. Одного вбито. Тікаєте під градом дротиків." },
      { text: "🙏 Попросити притулку", eff: { gold: 0, crew: 1, karma: 1, curse: 0 }, msg: "Тиждень притулку. Один матрос закохується і лишається на острові. Зате двоє островитян просяться з вами." },
    ],
  },
  // ── CREW ──
  {
  ...
  },
  {
    ...
    text: "Вдала здобич! Ром ллється рікою, пісні чути за милю.",
    ...
    choices: [
      ...
      { text: "🚫 Заборонити ром", eff: { gold: 0, crew: -1, karma: 0, curse: 0 }, msg: "Капітан, що забороняє ром, ходить по лезу. Шепіт незадоволення на палубі." },
  ...
  },
  {
    ...
    text: s => s.karma < -3 ? "Команда обступає з ножами. 'Ти занадто далеко зайшов, капітане.'" : "Частина команди вимагає змінити курс.",
    requires: s => s.day > 7,
    choices: [
      ...
      { text: "🗳️ Голосування", eff: { gold: 0, crew: 0, karma: 2, curse: 0 }, msg: s => s.karma >= 0 ? "Голосують за вас. Демократія працює, коли довіряють капітану." : "Голосують проти. Але приймаєте результат." },
    ],
  },
  {
  ...
  },
  {
    ...
    text: "На ранок трьох бракує. Втекли, прихопивши частину золота.",
    ...
    choices: [
      ...
      { text: "💨 Нехай ідуть", eff: { gold: -15, crew: -3, karma: 0, curse: 0 }, msg: "Менше ротів, менше зрадників. Хоча і рук менше." },
  ...
  },
  {
    ...
    text: "Двоє матросів хапаються за ножі. Свара через частку здобичі.",
    choices: [
      ...
      { text: "🍺 Ром вирішить", eff: { gold: -5, crew: 0, karma: 0, curse: 0 }, msg: "Через годину обнімаються і ридають одне одному в плече. Проблема не зникла, але відклалася." },
    ],
  },
  // ── COMBAT ──
  {
    ...
    choices: [
      { text: "⚔️ Бій!", eff: { gold: [0, 50], crew: [-4, -2], karma: -1, curse: 0, rep: { crown: -3, brethren: 2 } }, msg: s => s.flags?.has("armed") ? "Зброя контрабандиста вирішує бій!" : "Кривавий бій. Ледве вижили." },
      { text: "💨 Тікати", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: s => s.crew >= 6 ? "Повні вітрила! Корвет не встигає." : "Замало рук. Ледь відірвались." },
      { text: "🏳️ Прикинутись торговцем", eff: { gold: [-10, 0], crew: 0, karma: 0, curse: 0 }, msg: s => s.flags?.has("arms_dealer_enemy") ? "На борту корвету контрабандист! Впізнає вас. Доводиться тікати під обстрілом." : "Фальшиві документи спрацьовують. Серце шаленіє ще годину." },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: "🍺 Ром і розмова", eff: { gold: -5, crew: 0, karma: 1, curse: 0 }, msg: "Баррет виявляється балакучим п'яницею. Розповідає про острів, де безслідно пропадають кораблі.", flag: "knows_bermuda" },
  ...
  },
  {
    ...
    text: "Три торговці під охороною фрегата. Великий куш, та й ризик чималий.",
  ...
  },
  {
    ...
    text: "Прапор Кастилії на вітрі. Величезний галеон: повільний, але з сорока гарматами.",
    choices: [
      ...
      { text: "🏴 Підняти іспанський прапор", eff: { gold: 0, crew: 0, karma: -1, curse: 0 }, msg: "Підходите впритул. Поки розуміють, вже пізно. Але якщо хтось вцілів і впізнає вас...", flag: "spanish_disguise" },
      { text: "💨 Обійти стороною", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Не кожен бій варто починати. Розважливість на морі ціниться не менше за відвагу." },
    ],
  },
  // ── SUPERNATURAL ──
  {
    ...
    choices: [
      ...
      { text: "🎵 Слухати", eff: { gold: 0, crew: [-2, -1], karma: 0, curse: 3 }, msg: "Двоє стрибають за борт з блаженною посмішкою на вустах." },
      ...
      { text: "🐍 [Жриця] Покликати Лоа", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Ви креслите веве на палубі. Мама Бриджуотер навчила цього. Спів зупиняється. 'Ти говориш мовою глибини. Сестро.' У тумані з'являється обличчя, повне поваги.", flag: "siren_contact", requires_flag: "origin_voodoo" },
    ],
  },
  {
    id: "siren_return", scene: "ethereal", title: "Вона прийшла",
    text: "На носі корабля сидить жінка з перлинами у волоссі. Команда не бачить її. Тільки ви.",
  ...
  },
  {
    ...
    text: "Напівзгнилий галеон без прапора. На палубі скелети, і вони рухаються.",
    choices: [
      ...
      { text: "🔥 Підпалити", eff: { gold: 0, crew: 0, karma: 1, curse: -2 }, msg: "Вогонь пожирає мертве дерево. Звук: то чи крик, то чи зітхання полегшення." },
      ...
      { text: "🐍 [Жриця] Звільнити душі", eff: { gold: [20, 40], crew: 0, karma: 2, curse: -3 }, msg: "Ви витягаєте мішечок з кістками та починаєте ритуал. Духи зупиняються. Мертвий капітан схиляє голову. 'Нарешті.' Скелети розсипаються, а скарб залишається.", flag: "ghost_freed", requires_flag: "origin_voodoo" },
    ],
  },
  {
    ...
    text: "Вода закипає. Щупальця завтовшки зі щоглу обвивають корабель.",
    choices: [
  ...
  },
  {
    ...
    text: "Місяць заступає сонце. Темрява опускається. У небі проступають незнайомі зірки.",
    choices: [
      { text: "🔭 Вивчати зірки", eff: { gold: 0, crew: 0, karma: 0, curse: 2 }, msg: s => s.flags?.has("saved_martin") ? "Мартін блідне: 'Ці зірки — з іншого неба. Ми між світами.'" : "Ніби карта до місця, що не повинно існувати." },
      { text: "🙏 Молитись", eff: { gold: 0, crew: 0, karma: 1, curse: -1 }, msg: "Темрява відступає. Молитва допомогла, чи просто час минув?" },
  ...
  // ── CASTAWAY CHAIN ──
  {
    ...
    text: "Моряк чіпляється за дошку. Обличчя обпалене сонцем.",
    choices: [
  ...
  },
  {
    ...
    text: "Людина СТОЇТЬ на воді. Не тоне. Очі білі, без зіниць. Усміхається.",
  ...
  // ── PORT ──
  {
    ...
    text: "Піратська столиця. Тут усе продається і купується.",
    choices: [
      { text: "🔧 Ремонт (−20)", eff: { gold: -20, crew: 0, karma: 0, curse: 0, rep: { guild: 1 } }, msg: "Корпус підлатано, щоглу виправлено, гармати вичищено.", flag: "ship_repaired" },
  ...
  },
  {
    ...
    text: "Нассау. Губернатор оголосив помилування піратам, хто складе зброю.",
    requires: s => s.day > 10,
    choices: [
      { text: "📜 Прийняти помилування", eff: { gold: -30, crew: -2, karma: 4, curse: -3, rep: { crown: 4, brethren: -3 } }, msg: "Частину золота здаєте як 'податок'. Двоє не хочуть чесного життя і йдуть. Але тепер ви в межах закону." },
      { text: "🏴 Пограбувати порт", eff: { gold: [30, 60], crew: [-2, 0], karma: -4, curse: 2, rep: { crown: -4, brethren: 3 } }, msg: "Нассау палає. Тепер ваше ім'я знає кожен на Карибах." },
      { text: "💨 Повз", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Закон — не для вас." },
    ],
  },
  {
    id: "healer", scene: "port", title: "Знахарка",
    text: "Темна кімната, свічки, запах полину. Жінка, вкрита татуюваннями, дивиться крізь вас.",
  ...
  // ── CONSEQUENCES ──
  {
    ...
    text: "На ранок Мартіна немає. На палубі кров'ю виведено слово.",
  ...
  },
  {
    ...
    text: "Троє на весь корабель. Вітрила провисли. Кермо крутиться само по собі.",
    requires: s => s.crew <= 3 && s.crew > 0 && s.day >= 5,
    choices: [
      { text: "💪 Працювати разом", eff: { gold: 0, crew: 0, karma: 1, curse: 0 }, msg: "Кожен працює за трьох. Повільно, та все ж рухаємось. Між вами щось змінилося.", flag: "crew_bond" },
      { text: "💰 Обіцяти подвійну частку", eff: { gold: -15, crew: 0, karma: 0, curse: 0 }, msg: "Гроші мотивують. Але надовго?" },
      { text: "☠️ Прийняти долю", eff: { gold: 0, crew: 0, karma: 0, curse: 2 }, msg: "Примарні постаті з'являються біля штурвалу. Мертві матроси повертаються на вахту.", flag: "ghost_crew" },
    ],
  },
  {
    id: "crew_triumph", scene: "open_sea", title: "Сильна команда",
    text: "Палуба повна людей. Піратська пісня розрізає вітер. Корабель летить вперед.",
    ...
    choices: [
      ...
      { text: "⚓ Тренувати команду", eff: { gold: 0, crew: 0, karma: 0, curse: 0 }, msg: "Гарматні вправи, абордажні навчання. Тепер це не зграя волоцюг, а бойовий загін.", flag: "trained_crew" },
      { text: "🏴 Полювання на здобич", eff: { gold: [30, 60], crew: [-1, 0], karma: -2, curse: 0 }, msg: "З такою командою конвої тікають, ледве побачивши ваш прапор. Золото ллється рікою." },
    ],
  },
  ...
  },
  {
    ...
    text: "Білі дерева, чорний пісок. Час тут тече інакше.",
    requires: s => s.flags?.has("saw_phantom_island") || s.curse >= 8,
    choices: [
      { text: "🏝️ Висадитися", eff: { gold: [0, 40], crew: 0, karma: 0, curse: 3 }, msg: "На березі ваші речі. Ті, що ви ще не загубили. Це майбутнє? Паралельний світ?", flag: "visited_phantom" },
  ...
  },
  {
    ...
    text: "Вода прозора аж до самого дна. Колони, арки, загадкове світло.",
  ...
  },
  {
    ...
    choices: [
      { text: "🪞 Стрибнути", eff: { gold: 0, crew: 0, karma: 0, curse: 5 }, msg: "Внизу все навпаки. Команда мертва, ви безсмертний. Альтернатива чи пастка?" },
  ...
  },
  {
    ...
    text: "На палубі ваш двійник. Команда не може збагнути, хто справжній.",
    ...
    choices: [
      ...
      { text: "❓ Хто ти?", eff: { gold: 0, crew: 0, karma: 0, curse: 3 }, msg: "'Я -- це ти, який зробив правильні вибори. А ти -- помилка.' Зникає. Ви відчуваєте себе меншим." },
  ...
  },
  {
    ...
    text: "Стрілка шаленіє. Сонце не на своєму місці. Чи це ви не на своєму?",
    choices: [
...

  {
    ...
    text: "Людина чіпляється за уламок. Кричить про допомогу. Одяг занадто файний для простого моряка.",
    choices: [
      { text: "🆘 Врятувати", eff: { crew: 1, delay: { daysLater: 5, encounterId: "spy_betrayal", hint: "Новий матрос дивно себе поводить..." } }, msg: "Дякує без кінця. Каже, що колишній навігатор. Щось у його вдячності насторожує." },
      { text: "💨 Пропливти", eff: { gold: 0, crew: 0, karma: -1, curse: 0 }, msg: "Крики стихають. Тиша." },
    ],
  },
  {
    id: "spy_betrayal", scene: "combat", title: "Зрада!",
    text: "Врятований 'навігатор' виявився шпигуном Королівського флоту. Вночі подає сигнал ворожим кораблям.",
    requires: () => false,
    choices: [
  ...
  },
  {
    ...
    choices: [
      { text: "📦 Погодитися (50 золота)", eff: { gold: 50, delay: { daysLater: 3, encounterId: "cargo_awakens", hint: "Скриня видає звуки вночі..." } }, msg: "Скриня важка і теплішає на дотик. Хоча гроші непогані." },
