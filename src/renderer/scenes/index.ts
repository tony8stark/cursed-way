...
function sceneIsland(ctx: CanvasRenderingContext2D, W: number, H: number, f: number, ps: ParticleSystem, opts?: SceneOpts) {
  ...
  drawSprite(ctx, "building", W * 0.60, H * 0.18, 1.5);
  drawSprite(ctx, "palm", W * 0.74, H * 0.12, 2.5);
  drawSprite(ctx, "bush", W * 0.50, H * 0.36, 2);
...
function scenePort(ctx: CanvasRenderingContext2D, W: number, H: number, f: number, ps: ParticleSystem, opts?: SceneOpts) {
  ...
  drawSprite(ctx, "building", W * 0.44, H * 0.05, 2);
  drawSprite(ctx, "palm_big", W * 0.58, H * 0.02, 2);
  drawSprite(ctx, "building", W * 0.72, H * 0.08, 2.2);
  drawSprite(ctx, "bush", W * 0.88, H * 0.35, 2);
